...
(function (game) {
    var MainUI = (function (_super) {
        ...
        p.onRoleBtnClick = function (e) {
            game.AppFacade.getInstance().sendNotification(NoficationConfig.OPEN_ROLE);
        };
        p.onBackpackBtnClick = function (e) {
            game.AppFacade.getInstance().sendNotification(NoficationConfig.OPEN_BACKPACK);
        };
        p.onQianghuaBtnClick = function (e) {
            game.AppFacade.getInstance().sendNotification(NoficationConfig.OPEN_QIANGHUA);
        };
        p.onZhaoXianBtnClick = function (e) {
            game.AppFacade.getInstance().sendNotification(NoficationConfig.OPEN_ZHAOXIAN);
        };
        p.onChuangDangBtnClick = function (e) {
            game.AppFacade.getInstance().sendNotification(NoficationConfig.OPEN_CHUANGDANG);
        };
        p.onShopBtnClick = function (e) {
            game.AppFacade.getInstance().sendNotification(NoficationConfig.OPEN_SHOP);
        };
        p.onMapBtnClick = function (e) {
            game.AppFacade.getInstance().sendNotification(NoficationConfig.OPEN_MAP);
        };
