...
module game {
    ...
    export class ChuangDangMediator extends BaseMediator {
        ...
        public listNotificationInterests(): Array<any> {
            return [
                NoficationConfig.OPEN_CHUANGDANG,
                NoficationConfig.CLOSE_CHUANGDANG
            ];
        }
        ...
        private readExcelButtonClick(event: egret.TouchEvent): void {
            egret.setTimeout(function() {
                this.sendNotification(NoficationConfig.OPEN_CHUANGDANG);
            },this,100);
            this.closePanel(0);
